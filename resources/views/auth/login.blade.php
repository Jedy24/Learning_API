    ...
    <div class="row justify-content-center align-items-center" style="min-height: 60vh;">
        <div class="col-md-8">
            <div class="card" style="background-color: rgba(0, 0, 0, 0.7);" >
                <div class="card-header text-center" style="text-transform: uppercase; font-weight: bold; font-family: 'Apple Chancery, cursive'; font-size: 24px; color: white;">
                    {{ __('Login') }}
                </div>
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="col-md-12 text-center">
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <button type="submit" class="btn btn-primary rounded-pill mt-1 mb-1">
                                        {{ __('Login') }}
                                    </button>
                                </div>

                                <p class="text-center mt-0 mb-0" style="color: white; ">Don't have an account? <a href="{{ '/register' }}">Sign-Up</a></p>
                            </div>
                        </div>
                    </form>
                </div>
